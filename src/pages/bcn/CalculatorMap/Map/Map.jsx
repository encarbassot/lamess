...
export default function Map({zipCodeZones,zonesFees,startPlace, endPlace, handleClickCoords, path, editingCode}){
  ...
  const center = [41.4036963352364, 2.1636201722937414] //Barcelona
  ...
  return (
    ...
    > 
      <TileLayer
        url="https://cdn-tiles.bcn.cat/tiles/XYZ/PLANOLBCN/{z}/{x}/{y}.png"
