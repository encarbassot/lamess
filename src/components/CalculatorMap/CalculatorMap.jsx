...
//zone == "bcn" or zone == "mad"
export default function CalculatorMap({zone, zonesFees, prices}){



  const {defaultPickUpFee, defaultPickUpFeeHoliday, driverHourlyRateHoliday, driverHourlyRateWeekday, driverHourlyRateWeekend} = prices
  ...
  async function callGetZones(){
    const zones = await getZipCodeZones(zone)
